"""INRA Maroc → canonical node transformation.

Reads the INRAMAROC JSON-LD file and transforms it into canonical node
...
class InramarocIngester(BaseIngester):
    """Transform INRAMAROC JSON-LD to canonical node dicts."""
...
async def main():
    parser = argparse.ArgumentParser(description="INRAMAROC → transform nodes")
