...
Usage:
    python -m app.ingestion.crea_ingester \
        --jsonld ../nkz-crea-scraper/data/trials.jsonld
"""
...
class CreaIngester(BaseIngester):
    """Transform CREA JSON-LD to canonical node dicts."""
...
async def main():
    parser = argparse.ArgumentParser(description="CREA → transform nodes")
