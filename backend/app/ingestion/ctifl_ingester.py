"""CTIFL → canonical node transformation (BaseIngester subclass).

Reads the CTIFL JSON-LD file and transforms it into canonical node
dicts with mergeKeys and registry enrichment.

Usage:
    python -m app.ingestion.ctifl_ingester \
        --jsonld ../nkz-ctifl-scraper/data/trials.jsonld
"""
...
async def main():
    parser = argparse.ArgumentParser(description="CTIFL → transform nodes")
