...
def _get_tenant_id(request: Request) -> str:
    ...
    If both are empty (direct-ingress public endpoint), accept `tenant_id` as a
    query parameter (set by the frontend) or extract the tenant from the
    `parcel_id` URN query parameter (urn:ngsi-ld:Type:tenant:id).
    """
